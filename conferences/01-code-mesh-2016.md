...
* The Key ideas from distributed consensus come from the paper **The part-Time Parliement** bye Leslie Lamport \(\[Paxos\]\([https://en.wikipedia.org/wiki/Paxos\_\(computer\_science\)](https://en.wikipedia.org/wiki/Paxos_%28computer_science%29)\)\).
