...
GC is not perfect as it does use up extra resources to work and it’s normally not as efficient as proper manual memory management, but the problems it saves can make it more than worth it.
